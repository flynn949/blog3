...
So, we have a calculated power of `r round(mean(pvals <= 0.05),1)` for an effect of +1 mark. It is also interesting to look at the distribution of these p-values, in the logit scale.
