...
So, we have a calculated power of `r round(mean(pvals <= 0.05),1)` when there is an effect of +1 mark. Note that it is *possible* some of the p-values below 0.05 are actually associated with simulations where the tutoring effect was negative. Many could also be associated with simulations where the tutoring effect estimate, though statistically significant, may be very small, all it  needs to be is consistent and nonzero to get a small p-value. 
