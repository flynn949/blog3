...
### Simulation
Start with the basic parameters and something latent, let's call it aptitude, which for simplicity's sake will be the only thing (besides a bit of luck) that determines students' marks. As a latent variable, the most appropriate scale for this is be a standard normal.
