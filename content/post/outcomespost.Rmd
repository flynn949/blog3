...
power_simulation <- function(n_tutored = 50, n_untutored = 450, beta3, sigma_secondsession, beta0 = 58, beta1 = 0.9){
  ...
  #second_session <- second_session[order(first_session)]
...
So, we have a calculated power of `r round(mean(pvals <= 0.05),1)`. It is also interesting to look at the distribution of these p-values, in the logit scale.
